...
<body class="bg-gray-100">
    <div class="flex h-screen">
        ...
        <div id="sidebar" class="bg-gray-800 text-white w-64 flex-shrink-0 hidden md:block">
            ...
            <nav class="mt-4">
                <ul>
                    ...
                    <li class="mb-2">
                        <a href="{{ route('settings') }}" class="flex items-center px-4 py-2 text-gray-300 hover:bg-gray-700">
                            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <li class="mb-2">
                        <a href="{{ route('users') }}" class="flex items-center px-4 py-2 text-gray-300 hover:bg-gray-700">
                            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <li class="mb-2">
                        <a href="{{ route('login') }}" id="logout-button" class="flex items-center px-4 py-2 text-gray-300 hover:bg-gray-700">
                            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="md:hidden fixed top-0 left-0 z-50 w-full bg-gray-800 text-white p-4 flex justify-between items-center">
            <h2 class="text-xl font-bold">Admin Panel</h2>
        ...
        <div id="mobile-menu" class="md:hidden fixed top-14 left-0 z-40 w-full bg-gray-800 text-white hidden">
            <nav class="p-4">
                <ul>
                    ...
                    <li class="mb-2">
                        <a href="#" id="mobile-logout-button" class="flex items-center px-4 py-2 text-gray-300 hover:bg-gray-700">
                            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1"></path>
                            </svg>
                            Çıkış Yap
