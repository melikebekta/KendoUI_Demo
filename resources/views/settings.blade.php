        ...
        <div class="md:p-8 p-4 md:mt-0 mt-14">
            ...
            <div class="bg-white rounded-lg shadow p-6 max-w-lg mx-auto">
                ...
                <form method="post" action="{{ route('settings.post') }}">
                    @csrf
                    <div class="mb-4">
                        <label for="current-password" class="block text-gray-700 text-sm font-bold mb-2">Mevcut
                            Şifre</label>
                        <input type="password" name="cu_password"
                    ...
                    <div class="mb-6">
                        <label for="confirm-password" class="block text-gray-700 text-sm font-bold mb-2">Yeni Şifre
                            (Tekrar)</label>
                        <input type="password" id="confirm-password" name="co_password"
                            class="k-textbox w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
